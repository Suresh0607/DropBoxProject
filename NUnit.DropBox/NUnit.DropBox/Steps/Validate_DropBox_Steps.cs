...
namespace NUnit.DropBox.Steps
{
    ...
    public class Validate_DropBox_Steps
    {
        ...
        public void Given_User_With_Logs_Into_TheApplication(string userName, string password, string url)
        {
        ...
        public void Then_User_CanShareTo(string folderName, string eMailID)
        {
            file_page = new File_Page(_driver);
        ...
        public void Then_User_DeleteThe(string folderName)
        {
            file_page = new File_Page(_driver);
        ...
        public void Then_User_LogsOut_Of_TheApplication()
        {
        ...
        public void Then_user_Should_See_The_PageHeader_as(string pageTitle)
        {
        ...
        public void Then_User_ShouldSee_The_Newly_CreateFolder(string folder)
        {
            file_page = new File_Page(_driver);
        ...
        public void Then_Verify_Newly_UploadFiles_Under_TestFolder(string files, string folderName)
        {
            file_page = new File_Page(_driver);
        ...
        {
            //To DO- Verify Folder is shared to User
